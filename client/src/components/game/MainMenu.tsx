...
export function MainMenu() {
  ...
  if (menuState === "skins") {
    ...
    return (
      <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-gray-900 to-black pointer-events-auto px-4">
        <div className="text-center max-w-2xl max-h-screen overflow-y-auto">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-1">PADDLE SKINS</h1>
          <p className="text-gray-400 text-sm md:text-base mb-6">Unlock skins by winning rounds!</p>
            ...
            {allSkins.map((skin) => {
              ...
              return (
                ...
                >
                  ...
                  {!isUnlocked && (
                    <p className="text-yellow-400 text-sm font-semibold">🔒 LOCKED</p>
                  )}
