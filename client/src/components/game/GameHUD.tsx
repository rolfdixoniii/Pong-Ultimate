...
export function GameHUD() {
  ...
  const playerScore = usePong((state: any) => state.playerScore);
  const aiScore = usePong((state: any) => state.aiScore);
  const winner = usePong((state: any) => state.winner);
  const round = usePong((state: any) => state.round);
  const combo = usePong((state: any) => state.combo);
  const maxCombo = usePong((state: any) => state.maxCombo);
  const activeEffects = usePong((state: any) => state.activeEffects);
  const startGame = usePong((state: any) => state.startGame);
  const startNextRound = usePong((state: any) => state.startNextRound);
  ...
  const playerPowerHits = usePong((state: any) => state.playerPowerHits);
